    ...
    <div>
      ...
      <div>
        ...
        {visibleBooks.length === 0 ? (
          <p className='text-center py-8 text-2xl'>No book found!</p>
        ) : (
          <div>
              ...
              <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 sm:gap-16'>
                {visibleBooks.map((book) => (
                  <div
                    ...
                    className='flex flex-col items-center gap-2 px-6 py-16 lg:py-20 bg-gray-800 text-white rounded-2xl'
                  >
                    <Image
                      src={book.image}
                      alt={book.title}
